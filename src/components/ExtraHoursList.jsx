...
const ExtraHoursList = () => {
  ...
  // Función para obtener las horas extra por RUT, mes y año
  ...
  // Función para aprobar una hora extra
  ...
  return (
    <div>
      <Typography variant="h4">Buscar Horas Extra por RUT, Mes y Año</Typography>
